#define __FILEPATH__ "antenna/control/specific/MountOffset.cc"
...
void MountOffset::set(OffsetMsg msg)
{
  ...
  case OffsetMsg::ADD:
    ...
    //if(msg.axes & OffsetMsg::PA)
      //pa_ = wrapPi(el_ + msg.body.mount.pa);
    break;
...
/**.......................................................................
 * Return the parallactic angle offset
 */
//double MountOffset::getPa()
//{
  //return pa_;
//}
