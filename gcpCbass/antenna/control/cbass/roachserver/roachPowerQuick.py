...
#		fpga.write_int('acc_len',1000000)
		...
		fpga.write_int('enablePhaseSwitch',1) #turn on phase switching - positive logic
		fpga.write_int('demodPhaseSwitch1',0) #turn on demodulation- negative logic
		fpga.write_int('phaseFrequency',1200) #fft size
...
#			time.sleep(0.001)
	...
	#		Channel4=readIntegration64bit('Subsystem1_ch7','Subsystem1_ch8')
			...
			out1= numpy.mean(Channel1[2:48],dtype=numpy.uint64)+numpy.mean(Channel1[50:63],dtype=numpy.uint64)
	#		out2= numpy.mean(Channel2[10:15],dtype=numpy.uint64)
	#		out3= numpy.mean(Channel3[10:15],dtype=numpy.uint64)
	#		out4= numpy.mean(Channel4[10:15],dtype=numpy.uint64)
			out1=10*numpy.log10(out1)
			out2=10*numpy.log10(out1)
			out3=10*numpy.log10(out1)
			out4=10*numpy.log10(out1)
