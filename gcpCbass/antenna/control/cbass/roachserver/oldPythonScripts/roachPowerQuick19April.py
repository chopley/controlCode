...
bitstreampower = 'cbassrx_19aprc_pow_2012_Apr_19_2045'
...
#		fpga.write_int('acc_len',1000000)
		...
		fpga.write_int('Demod_transL',7) #fft size
		print 'done'
...
#		plotSpectrum4(Chan1Diff,Chan2Diff,Chan3Diff,Chan4Diff,Chan1Diff,Chan2Diff,Chan3Diff,Chan4Diff,"OnChannelCalibrated")
		...
		fpga.write_int('enablePhaseSwitch',1) #fft size
		fpga.write_int('phaseFrequency',100000) #fft size
		fpga.write_int('demodPhaseSwitch1',0) #fft size
		fpga.write_int('phaseDelay2',30) #fft size
		fpga.write_int('Demod_transL',7) #fft size
		...
		##check the phase switching
		fpga.write_int('ADCedgePolarity',0) #fft sizeD
		adc1On = getSnapCat('ADCChannel1')
		#adc2On= getSnapCat('ADCChannel2')
		#adc3On= getSnapCat('ADCChannel3')
		#adc4On= getSnapCat('ADCChannel4')
		fpga.write_int('ADCedgePolarity',1) #fft sizeD
		adc1Off = getSnapCat('ADCChannel1')
		#adc2Off= getSnapCat('ADCChannel2')
		#adc3Off= getSnapCat('ADCChannel3')
		#adc4Off= getSnapCat('ADCChannel4')
		#dc1On=numpy.array(adc1On)
		#dc1Off=numpy.array(adc1Off)
		numpy.savetxt('ADCSamplesPos.txt',adc1On)
		numpy.savetxt('ADCSamplesNeg.txt',adc1Off)
		while(1):
