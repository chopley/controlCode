...
///this is the main roach loop- this will run continuously giving accurate 10ms integrations. Data is read in from the powerPc and packed into a circular buffer. This is then read at 100ms intervals giving 10 packets per data transfer to the control pc
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	cbassPKT.version=1; //version numbers of the Polarisation begin at 0
