...
bitstreampol = 'cbassrx_5mar_pol_2012_Mar_05_1144'#the bof file to get the polarisations
bitstreampol = 'cbassrx_6mar_pol_2012_Mar_06_1013'
...
#		fpga.write_int('acc_len',1000000)
		...
		fpga.write_int('acc_sync_delay',2) #fft size
		
		fpgaND.write_int('acc_len',78125)
		print 'done',str(opts.acc_len)
		...
		fpgaND.write_int('acc_sync_delay',2) #fft size
		print 'done'
