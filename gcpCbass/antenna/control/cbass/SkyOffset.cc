#define __FILEPATH__ "antenna/control/specific/SkyOffset.cc"
...
void SkyOffset::print()
{
  DBPRINT(false, Debug::DEBUGANY, "x is: " << x_ << std::endl << "y is: " << y_);
}
 ...
 */
std::ostream& 
gcp::antenna::control::operator<<(ostream& os, SkyOffset& off)
{
  os << "x_ = " << off.x_ << " y_ = " << off.y_;
  return os;
}
