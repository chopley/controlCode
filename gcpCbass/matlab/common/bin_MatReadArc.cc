...
void assignDateVals(gcp::matlab::MexHandler::MxArray& array, double* dPtr, 
		    gcp::util::MonitorDataType::FormatType format, unsigned iFrame, unsigned nFrame,
		    gcp::util::CoordAxes& axes);

void assignDateValsOld(gcp::matlab::MexHandler::MxArray& array, double* dPtr, 
		 ...
		 int nrhs, const mxArray *prhs[])
{
  ...
  try {  
    ...
    MexHandler::checkArgs(1, 5, nlhs, nrhs);
		...
		unsigned nFrame)
{
  ...
  if(selectedFormat == MonitorDataType::FM_STRING) {
    ...
    assignDateVals(array, dPtr, selectedFormat, iFrame, nFrame, axes);
  } else {
 ...
 */
void assignDateVals(MexHandler::MxArray& array, double* dPtr, 
		    MonitorDataType::FormatType format, unsigned iFrame, unsigned nFrame,
		    CoordAxes& axes)
{
  RegDate date;
  static int count=0;
 ...
 * Convert a date to a string value in a matlab cell array
 */
void assignDateValsOld(MexHandler::MxArray& array, double* dPtr, 
