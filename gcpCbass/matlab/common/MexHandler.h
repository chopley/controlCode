// $Id: MexHandler.h,v 1.4 2010/03/03 18:23:12 eml Exp $
 ...
 * 
 * @version: $Revision: 1.4 $, $Date: 2010/03/03 18:23:12 $
 * 
 * @author Erik Leitch
 */
#include <iostream>
...
namespace gcp {
  ...
  namespace matlab {
	...
	void operator=(mxArray* array) {
      ...
      static mxArray* createMatlabArray(int ndim, const int* dims, 
       ...
       */
      static mxArray* createRegValArray(mxArray* ptr, 
