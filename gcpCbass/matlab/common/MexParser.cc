...
const int* MexParser::getDimensions(mxArray* arr)
{
  ...
  return (const int*)mxGetDimensions(arr);
}

const int* MexParser::getDimensions(const mxArray* arr)
{
  return getDimensions((mxArray*) arr);
}

const int* MexParser::getDimensions()
{
...
int MexParser::getDimension(mxArray* arr, unsigned iDim)
{
  ...
  const int* dims = getDimensions(arr);
...
bool MexParser::dimensionsMatch(mxArray* arr1, mxArray* arr2)
{
  ...
  const int* dims1 = getDimensions(arr1);
  const int* dims2 = getDimensions(arr2);
