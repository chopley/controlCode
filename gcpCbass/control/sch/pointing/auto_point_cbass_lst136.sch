(Count npoints) # number of points to record on each star

# gen set of stars using matlab function star_set in spt_analysis archive

# should start at roughly 07:00 lst., if counts ~11 or 12, should run for ~10 hours.

#200 sources * 11 reps / ~3.5 reps/min ~ 10 hours.
...
setOpticalCameraRotation angle=-0:30:00
...
configureFrameGrabber combine=15
