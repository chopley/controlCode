...
//#define GRABBER_XNPIX 768   /* SA telescope */
...
/**
 * The length, in bytes of the (short) channel specifier
 */
#define OPTCAM_CHAN_LEN 2
 ...
 */
#define OPTCAM_BUFF_SIZE  (NET_PREFIX_LEN + OPTCAM_DATE_LEN + OPTCAM_CHAN_LEN + OPTCAM_TRK_POS_LEN + GRABBER_IM_SIZE*2)
