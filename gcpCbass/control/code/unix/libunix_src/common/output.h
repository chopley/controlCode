...
int output_int(OutputStream *stream, OutputBase base, char *flags, int width,
		int precision, int lval);
int output_uint(OutputStream *stream, OutputBase base, char *flags, int width,
		int precision, unsigned int ulval);
