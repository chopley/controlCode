...
namespace gcp {
  namespace control {
	...
	*dayno = mjd - mjd_of_year(*year) + 1;
     ...
     */
    char *name_of_month(int month, int upper_case, int abbreviate)
      {
	static char *capitalized_names[] = {
	  "January", "February", "March",     "April",   "May",      "June",
	  "July",    "August",   "September", "October", "November", "December"
	};
	static char *upper_case_names[] = {
	  "JANUARY", "FEBRUARY", "MARCH",     "APRIL",   "MAY",      "JUNE",
	  "JULY",    "AUGUST",   "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER"
	};
	static char *capitalized_short[] = {
	  "Jan", "Feb", "Mar", "Apr", "May", "Jun",
	  "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"
	};
	static char *upper_case_short[] = {
	  "JAN", "FEB", "MAR", "APR", "MAY", "JUN",
	  "JUL", "AUG", "SEP", "OCT", "NOV", "DEC"
	};
	/*
