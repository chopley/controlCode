 ...
 */
int addRegSetRange(RegSet* regset, gcp::util::RegDescription& parser);
 ...
 */
int net_put_RegSet(RegSet *regset, gcp::control::NetBuf *net);
int netPutRegSet(RegSet *regset, gcp::control::NetBuf *net);
 ...
 */
int net_get_RegSet(RegSet* registerSet, gcp::control::NetBuf *net);
int netGetRegSet(RegSet* registerSet, gcp::control::NetBuf *net);

/*
 * Return the number of bytes needed to pack a selected set of
 * register values into a NetBuf network buffer.
 */
int net_regs_size(RegSet* registerSet);
...
int net_put_regs(RegSet* registerSet, 
		 RegRawData *raw, gcp::control::NetBuf *net);
