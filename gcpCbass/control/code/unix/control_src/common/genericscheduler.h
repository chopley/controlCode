#ifndef genericscheduler_h
#define genericscheduler_h
 ...
 * other threads. See genericcontrol.h for thread-safe scheduler facitities.
 */
 ...
 */
int sch_queue_schedule(Scheduler *sch, Script *sc, int iQueue=-1);
 ...
 */
gcp::control::Site *sch_Site(Scheduler *sch);
 ...
 * mark command has been issued, sch_drive_done() returns true.
 */
unsigned sch_next_mark_seq(Scheduler *sch);
 ...
 */
unsigned sch_next_setreg_seq(Scheduler *sch);
 ...
 * returns true.  */
unsigned sch_next_offset_seq(Scheduler *sch);
 ...
 */
unsigned sch_next_grab_seq(Scheduler *sch);
unsigned int sch_grab_done(Scheduler *sch);
 ...
 */
void processSpecificSchedulerMessage(unsigned id, 
				     gcp::util::NewNetMsg* netmsg, 
				     gcp::control::TransactionStatus* trans,
				     unsigned antenna);

/**.......................................................................
 * Return an instantiation of experiment-specific transactions
 */
gcp::control::TransactionStatus* new_SpecificTransactions();
