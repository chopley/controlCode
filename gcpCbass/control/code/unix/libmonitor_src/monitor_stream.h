...
#include "gcp/util/common/RegisterSet.h"
...
gcp::control::MsReadState (fn)(gcp::control::MonitorStream *ms, int dowait)
...
gcp::control::MsSendState (fn)(gcp::control::MonitorStream *ms, int dowait)
...
gcp::control::MsSendState (fn)(gcp::control::MonitorStream *ms)
 ...
 */
#define MS_SELECT_FD(fn) int (fn)(gcp::control::MonitorStream *ms)
 ...
 */
#define MS_ARRAYMAP(fn) ArrayMap *(fn)(gcp::control::MonitorStream *ms)

/*.......................................................................
 * Return the current register map of the stream.
 */
#define MS_REGMAP(fn) RegMap *(fn)(gcp::control::MonitorStream *ms)
...
namespace gcp {
  namespace control {
    ...
    typedef struct MonitorStream {
      ...
      gcp::util::RegisterSet* prepRegSet;

      // The established selection of registers 
      
      gcp::util::RegisterSet* regSet;

      // The register calibration object 

      gcp::util::RegCal* regCal;
 ...
 */
gcp::control::MonitorStream *new_NetMonitorStream(char *host);
 ...
 * object. On failure it returns NULL.
 */
gcp::control::MonitorStream *new_FileMonitorStream(char *dir, double ta, double tb);

// Constructor for reading a named file

gcp::control::MonitorStream *new_FileMonitorStream(char *filename);
 ...
 * argument).
 */
gcp::control::MonitorStream *del_MonitorStream(gcp::control::MonitorStream *ms);
 ...
 */
gcp::control::MsReadState ms_read_frame(gcp::control::MonitorStream *ms, int dowait);
gcp::control::MsReadState ms_count_frame(gcp::control::MonitorStream *ms, int dowait);
 ...
 */
int ms_get_float(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
		 float *data, gcp::util::CoordRange* range=0);
int ms_get_double(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
		  double* data, gcp::util::CoordRange* range=0);
int ms_get_uint(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
		unsigned* data, gcp::util::CoordRange* range=0);
int ms_get_int(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
	       int* data, gcp::util::CoordRange* range=0);
int ms_get_ushort(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
		unsigned short* data, gcp::util::CoordRange* range=0);
int ms_get_short(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
	       short* data, gcp::util::CoordRange* range=0);
int ms_get_uchar(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
		 unsigned char* data, gcp::util::CoordRange* range=0);
int ms_get_char(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
		char* data, gcp::util::CoordRange* range=0);
int ms_get_ulong(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
		 unsigned long* data, gcp::util::CoordRange* range=0);
int ms_get_long(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
		long* data, gcp::util::CoordRange* range=0);

int ms_get_date(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
		gcp::util::RegDate::Data* data, gcp::util::CoordRange* range=0);

int ms_get_complex_float(gcp::control::MonitorStream *ms, 
			 gcp::util::RegDescription* desc, 
			 gcp::util::Complex<float>::Data* data, 
			 gcp::util::CoordRange* range=0);


int ms_get_float(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
		 gcp::util::MonitorDataType* data, gcp::util::RegAxisRange& range);
...
int ms_get_complex_float(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
			 gcp::util::MonitorDataType* data, gcp::util::RegAxisRange& range);
			 

int ms_get_double(gcp::control::MonitorStream *ms, gcp::util::RegDescription* desc, 
		  double* data, gcp::util::RegAxisRange& range);			 
 ...
 */
int ms_get_string(gcp::control::MonitorStream *ms, gcp::util::RegDescription *reg, unsigned nc, char *string);
 ...
 */
gcp::control::MsSendState ms_send_msg(gcp::control::MonitorStream *ms, int dowait);
 ...
 */
gcp::control::MsSendState ms_queue_regset(gcp::control::MonitorStream *ms);
 ...
 */
gcp::control::MsSendState ms_queue_interval(gcp::control::MonitorStream *ms, unsigned interval);
 ...
 * calls to ms_send_msg() will be needed to complete the transaction.
 */
gcp::control::MsSendState ms_queue_rewind(gcp::control::MonitorStream *ms);

/*
 * Return true if the data source of the specified stream can be rewound.
 */
int ms_can_be_rewound(gcp::control::MonitorStream *ms);
 ...
 */
int ms_select_fd(gcp::control::MonitorStream *ms);
 ...
 */
int ms_load_cal_file(gcp::control::MonitorStream *ms, char *dir, char *name);

/*
 * Load calibration parameters from a text input stream.
 * See input.h to see how to create input streams.
 */
int ms_load_cal_stream(gcp::control::MonitorStream *ms, InputStream *stream);

/*
 * Reset all calibration parameters to unit scale factors, and
 * zero offsets.
 */
int ms_reset_cal(gcp::control::MonitorStream *ms);
...
struct MonitorSelection {
  ...
  void initialize(int id, std::string regMapName, std::string boardName, 
		  std::string blockName, gcp::util::CoordRange* range);

  // Constructor

  MonitorSelection(int id, std::string regMapName, std::string boardName, 
		   std::string blockName, gcp::util::CoordRange* range=0);
 ...
 *                                           dispatched.
 */
gcp::control::MsSendState ms_select_regs(gcp::control::MonitorStream *ms, 
 ...
 * datatype.
 */
ArrayMap *ms_ArrayMap(gcp::control::MonitorStream *ms);
 ...
 */
gcp::util::RegCal::RegCalData* ms_RegCalData(gcp::control::MonitorStream *ms);
 ...
 * See regdata.h for a description of the RegCalData datatype.
 */
RegRawData *ms_RegRawData(gcp::control::MonitorStream *ms);
 ...
 * the RegSet datatype.
 */
gcp::util::RegisterSet* ms_RegSet(gcp::control::MonitorStream *ms);

/*
 * Return the current sub-sampling interval (or 0 if the stream is
 * unconnected).
 */
unsigned ms_get_interval(gcp::control::MonitorStream *ms);
 ...
 */
gcp::util::RegisterSet *ms_prep_RegSet(gcp::control::MonitorStream *ms);
 ...
 */
gcp::control::MonitorStream *new_MonitorStream(bool archivedOnly);
 ...
 */
int open_MonitorStream(gcp::control::MonitorStream *ms, void *context, MS_DESTRUCTOR(*del_fn),
 ...
 * function.
 */
void *ms_SourceContext(gcp::control::MonitorStream *ms);
 ...
 */
void close_MonitorStream(gcp::control::MonitorStream *ms);
