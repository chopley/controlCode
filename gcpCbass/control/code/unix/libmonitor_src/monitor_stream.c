...
MsReadState ms_read_frame(MonitorStream *ms, int dowait)
{
  ...
  case MS_READ_DONE:
    ...
    try {
      ...
      DBPRINT(true, gcp::util::Debug::DEBUGANY, "====== Exception: ====== " << err.what());
      return MS_READ_ENDED;
    }
    return MS_READ_DONE;
  };
...
static int ms_change_regmap(MonitorStream *ms)
{
  ...
  ms->prepRegSet = new gcp::util::RegisterSet(ms->arraymap, ms->archivedOnly_);
  if(ms->prepRegSet==0)
    return bad_regmap_change(ms);
  
  ms->regSet = new gcp::util::RegisterSet(ms->arraymap, ms->archivedOnly_);
  if(ms->regSet==0)
    return bad_regmap_change(ms);
  
  // Allocate the register calibration object.
  
  ms->regCal = new gcp::util::RegCal(ms->arraymap, ms->archivedOnly_);
  if(ms->regCal==0)
    return bad_regmap_change(ms);
...
MsSendState ms_queue_regset(MonitorStream *ms)
{
  ...
  for(i=0; i < (int)(sizeof(mandatory_regs)/sizeof(mandatory_regs[0])); i++) {
    ...
    gcp::util::RegDescription reg(ms->prepRegSet->archivedOnly());
...
{
  MonitorStream* ms=0;  /* The new iterator */
  /*
		       ...
		       bool archivedOnly)
{
  ...
  // Get the new register map and allocate register-map dependent
  // objects.  On error this function closes the monitor stream and
  // returns 1.
 ...
 *                          be NULL if the stream is closed or if ms==NULL.
 */
gcp::util::RegCal::RegCalData* ms_RegCalData(MonitorStream *ms)
{
 ...
 */
gcp::util::RegisterSet *ms_prep_RegSet(MonitorStream *ms)
{
 ...
 *                          NULL if the stream is closed or if ms==NULL.
 */
gcp::util::RegisterSet *ms_RegSet(MonitorStream *ms)
{
			   ...
			   std::vector<gcp::util::RegDescription>& regs)
{
  try {
    ...
    for(unsigned iSel=0; iSel < selections.size(); iSel++) {
      ...
      gcp::util::RegDescription desc(ms->prepRegSet->archivedOnly(), 
				     ms->arraymap);
 ...
 *                        1 - Error.
 */
int ms_get_float(MonitorStream *ms, gcp::util::RegDescription* desc, float *data,
...
int ms_get_float(MonitorStream *ms, gcp::util::RegDescription* desc, 
		 gcp::util::MonitorDataType* data,
		 gcp::util::RegAxisRange& range)
{
  // Retrieve the requested registers.
 ...
 *                        1 - Error.
 */
int ms_get_double(MonitorStream *ms, gcp::util::RegDescription* desc, double *data, 
		  gcp::util::CoordRange* range)
{
  try {
...
int ms_get_double(MonitorStream *ms, gcp::util::RegDescription* desc, 
		  gcp::util::MonitorDataType* data,
		  gcp::util::RegAxisRange& range)
{
  try {
...
int ms_get_short(MonitorStream *ms, gcp::util::RegDescription* desc, short* data, 
	       gcp::util::CoordRange* range)
{
  // Retrieve the requested registers.
  ...
  try {
    ...
    ms->regCal->calData()->getCalShort(desc, data, range);
  } catch(...) {
    return 1;
  }
  return 0;
...
int ms_get_short(MonitorStream *ms, gcp::util::RegDescription* desc,
	       gcp::util::MonitorDataType* data,
	       gcp::util::RegAxisRange& range)
{
  // Retrieve the requested registers.
...
int ms_get_ushort(MonitorStream *ms, gcp::util::RegDescription* desc, 
		  unsigned short *data,
		  gcp::util::CoordRange* range)
{
  // Retrieve the requested registers.
  ...
  try {
    ...
    ms->regCal->calData()->getCalUshort(desc, data, range);
  } catch(...) {
    return 1;
  }
  return 0;
 ...
 *                        1 - Error.
 */
int ms_get_uint(MonitorStream *ms, gcp::util::RegDescription* desc, unsigned *data,
		gcp::util::CoordRange* range)
{
  // Retrieve the requested registers.
...
int ms_get_uint(MonitorStream *ms, gcp::util::RegDescription* desc,
		gcp::util::MonitorDataType* data,
		gcp::util::RegAxisRange& range)
{
  // Retrieve the requested registers.
 ...
 *                        1 - Error.
 */
int ms_get_char(MonitorStream *ms, gcp::util::RegDescription* desc, char* data, 
	       gcp::util::CoordRange* range)
{
  // Retrieve the requested registers.
...
int ms_get_char(MonitorStream *ms, gcp::util::RegDescription* desc,
		gcp::util::MonitorDataType* data,
		gcp::util::RegAxisRange& range)
{
  // Retrieve the requested registers.
 ...
 *                        1 - Error.
 */
int ms_get_uchar(MonitorStream *ms, gcp::util::RegDescription* desc, unsigned char* data, 
	       gcp::util::CoordRange* range)
{
  // Retrieve the requested registers.
...
int ms_get_uchar(MonitorStream *ms, gcp::util::RegDescription* desc,
		gcp::util::MonitorDataType* data,
		gcp::util::RegAxisRange& range)
{
  // Retrieve the requested registers.
 ...
 *                        1 - Error.
 */
int ms_get_int(MonitorStream *ms, gcp::util::RegDescription* desc, int* data, 
	       gcp::util::CoordRange* range)
{
  // Retrieve the requested registers.
...
int ms_get_int(MonitorStream *ms, gcp::util::RegDescription* desc,
	       gcp::util::MonitorDataType* data,
	       gcp::util::RegAxisRange& range)
{
  // Retrieve the requested registers.
 ...
 *                        1 - Error.
 */
int ms_get_ulong(MonitorStream *ms, gcp::util::RegDescription* desc, unsigned long *data,
		 gcp::util::CoordRange* range)
{
  // Retrieve the requested registers.
...
int ms_get_ulong(MonitorStream *ms, gcp::util::RegDescription* desc,
		 gcp::util::MonitorDataType* data,
		 gcp::util::RegAxisRange& range)
{
  // Retrieve the requested registers.
 ...
 *                        1 - Error.
 */
int ms_get_long(MonitorStream *ms, gcp::util::RegDescription* desc, long *data, 
		gcp::util::CoordRange* range)
{
  // Retrieve the requested registers.
...
int ms_get_long(MonitorStream *ms, gcp::util::RegDescription* desc,
		gcp::util::MonitorDataType* data,
		gcp::util::RegAxisRange& range)
{
  // Retrieve the requested registers.
 ...
 *                        1 - Error.
 */
int ms_get_string(MonitorStream *ms, gcp::util::RegDescription* desc, unsigned nc, 
		  char *string)
{
  // Retrieve the requested registers.
 ...
 *                        1 - Error.
 */
int ms_get_date(MonitorStream *ms, gcp::util::RegDescription* desc, 
		gcp::util::RegDate::Data* data, 
		gcp::util::CoordRange* range)
{
  // Retrieve the requested registers.
 ...
 *                        1 - Error.
 */
int ms_get_complex_float(MonitorStream *ms, gcp::util::RegDescription* desc, 
				  ...
				  gcp::util::CoordRange* range)
{
  ...
  range_ = new gcp::util::CoordRange(range);
}
