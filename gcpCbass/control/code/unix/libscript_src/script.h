 ...
 */
struct Enumerator {      /* An enumeration name/value pair */
  char *name;            /* The name of the enumerator */
  unsigned value;        /* The value of the enumerator */
  char* explanation;     /* An optional explanation of what this value means */
};
 ...
 */
Symbol *add_ScriptSymbol(Script *sc, char *name, SymbolType code, void *data, bool isAlias=false);
 ...
 * error reporting.
 */
Symbol *find_ScriptSymbol(Script *sc, InputStream *stream, char *name, bool printError=true);
