...
static FILE		*ngp_fp[NGP_MAX_INCLUDE];	/* stack of included file handles */
int		ngp_keyidx = NGP_TOKEN_UNKNOWN;	/* index of token in current line */
static NGP_TOKEN	ngp_linkey;			/* keyword after line analyze */

static char            ngp_master_dir[NGP_MAX_FNAME];  /* directory of top level include file */
