#define __FILEPATH__ "util/common/CenterManager.cc"
...
CenterManager::getCenterAssociations(AntNum::Id antennas)
{
  ...
  std::vector<std::pair<gcp::control::SourceId, AntNum::Id> > outputVec;
  ...
  {
    std::pair<gcp::control::SourceId, AntNum::Id> testPair;
 ...
 */
Center* CenterManager::getCenter(gcp::control::SourceId* srcId, bool throwOnError)
{
  LogStream errStr;
