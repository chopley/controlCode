#define __FILEPATH__ "util/common/QuadraticInterpolator.cc"
 ...
 */
std::ostream& 
gcp::util::operator<<(std::ostream& os, QuadraticInterpolator& quad)
{
  os << endl
     << "    x1 = " << quad.s_[0].x << " x2 = " << quad.s_[1].x << " x3 = " << quad.s_[2].x << endl
     << "    y1 = " << quad.s_[0].y << " y2 = " << quad.s_[1].y << " y3 = " << quad.s_[2].y;
  return os;
}
