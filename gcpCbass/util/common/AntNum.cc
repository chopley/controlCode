#define __FILEPATH__ "util/common/AntNum.cc"
 ...
 */
bool gcp::util::isValidAnt(unsigned int ant)
{
...
#if DIR_IS_STABLE
      os << "eventChannel" << iant << ends;
#else
      os << "eventChannelUnstable" << iant << ends;
#endif
...
#if DIR_IS_STABLE
  os << "eventChannel" << ends;
#else
  os << "eventChannelUnstable" << ends;
#endif
...
unsigned int AntNum::getIntId()
{
  ...
  throw Error("AntNum::getIntId: Antenna enumerator does not specify "
  	      "a valid single antenna id.\n");
}
 ...
 */
std::string gcp::util::printAntennaSet(AntNum::Id antennas)
{
  ostringstream os;
...
{
  return gcp::util::printAntennaSet(id);
}
...
{
  return gcp::util::printAntennaSet(id_);
}
 ...
 */
ostream& 
gcp::util::operator<<(ostream& os, const AntNum& ant)
{
  AntNum antiter(AntNum::ANT0),antmax(AntNum::ANTMAX);
  int iant;
  bool first=true;
...
#ifndef GCC3_2_2_SUCKS
/**.......................................................................
 * Write the contents to an sstream
 */
ostringstream& 
gcp::util::operator<<(ostringstream& os, const AntNum& ant)
{
  AntNum antiter(AntNum::ANT0),antmax(AntNum::ANTMAX);
  int iant;
 ...
 */
AntNum::Id 
gcp::util::operator+(const AntNum::Id id1, const AntNum::Id id2)
{
  unsigned int i1, i2;
 ...
 */
bool gcp::util::isValidAntennaSet(AntNum::Id antennas)
{
 ...
 */
unsigned gcp::util::idToInt(AntNum::Id id)
{
  AntNum antNum(id);
 ...
 * Convert from receiver index to enumerator
 */
AntNum::Id gcp::util::intToId(unsigned int iant)
{
