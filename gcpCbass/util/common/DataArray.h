#ifndef GCP_UTIL_DATAARRAY_H
#define GCP_UTIL_DATAARRAY_H
...
#include "gcp/control/code/unix/libunix_src/common/regmap.h" // RegAddrMode
...
#endif // End #ifndef GCP_UTIL_DATAARRAY_H
