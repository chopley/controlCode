#define __FILEPATH__ "util/common/DataType.cc"
...
DataType::Type DataType::typeOf(gcp::util::RegDate* obj)
{
...
DataType::Type DataType::typeOf(gcp::util::RegDate::Data* obj)
{
  return DataType::DATE;
}
