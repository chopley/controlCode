#define __FILEPATH__ "util/common/NetCommHandler.cc"
 ...
 */
void NetCommHandler::packNetMsg(gcp::util::NetMsg* netMsg)
{
 ...
 * Pack a network message into our send buffer
 */
bool NetCommHandler::packNewRtcNetMsg(gcp::util::NetMsg* netMsg)
{
  return netMsgHandler_.packNewRtcNetMsg(netMsg);
}
 ...
 * Pack a network command into our send buffer
 */
void NetCommHandler::packNetCmd(gcp::util::NetCmd* netCmd)
{
