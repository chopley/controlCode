#ifndef GCP_UTIL_REGRANGE_H
#define GCP_UTIL_REGRANGE_H
...
namespace gcp {
  namespace util {
    ...
    private:
       ...
       */
      RegRange(RegRange& range);
      RegRange(const RegRange& range);
      
      /**
       * Assignment operator not allowed
       */
      void operator=(RegRange& range);
      void operator=(const RegRange& range);
    ...
    private:
      ...
      ArrayMapBase arrayMapBase_;// The GCP array map 
...
#endif // End #ifndef GCP_UTIL_REGRANGE_H
