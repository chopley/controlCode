#ifndef GCP_UTIL_QUADPATH_H
#define GCP_UTIL_QUADPATH_H
...
#include "gcp/control/code/unix/libunix_src/common/const.h" // pi and twopi
...
namespace gcp {
  namespace util {
     ...
     * which is required by certain gcp::control functions.
     */
    class QuadPath {
    ...
    private:
       ...
       * gcp::control::QuadPath.
       */
      gcp::control::QuadPath* quadpath_;
