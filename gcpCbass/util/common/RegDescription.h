#ifndef GCP_UTIL_REGDESCRIPTION_H
#define GCP_UTIL_REGDESCRIPTION_H
...
#include "gcp/util/common/Range.h"
...
namespace gcp {
  namespace util {
    ...
    private:
      ...
      int iRegMap_;        // The index of the specified register map
			   // in the array map
      ...
      int iSlot_;          // The frame index of the first element of
			   // this register. NB: This is the frame
			   // offset of the _first_ element of this
			   // register, and not the offset of the
			   // first requested element (i.e., of
			   // range_.startCoord())
      ...
      int iByte_;          // The byte index into the array map of the
			   // first element of the requested
			   // register. NB: This is the offset of the
...
#endif // End #ifndef GCP_UTIL_REGDESCRIPTION_H
