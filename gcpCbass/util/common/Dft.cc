 ...
 * Constructor.
 */
Dft::Dft(int n, bool optimize, Apodization apod)
{
  in_           = 0;
  out_          = 0;
  nAv_          = 0;
...
{
  std::cout << "Calling default assignment operator for class: Dft" << std::endl;
};

/**.......................................................................
 * Output Operator.
 */
std::ostream& gcp::util::operator<<(std::ostream& os, Dft& obj)
{
  os << "Default output operator for class: Dft" << std::endl;
  return os;
};
 ...
 */
void Dft::computePlan(unsigned flag) 
{
...
double Dft::apodizationCoefficient(unsigned iSamp)
{
 ...
 * Update the min max
 */
void Dft::updateMinMax(unsigned i, double& val, bool doLog, 
 ...
 * Return the absolute value of the output array
 */
void Dft::abs(float* outputPtr, bool& first, 
...
void Dft::assertApodizationType(Apodization type)
{
  switch (type) {
  case APOD_RECTANGLE:
...
APOD_FN(Dft::apodRectangle)
{
  return 1.0;
}

APOD_FN(Dft::apodHamming)
{
  return 0.54 - 0.46 * cos((2*M_PI*iSamp)/(n - 1));
}

APOD_FN(Dft::apodHann)
{
