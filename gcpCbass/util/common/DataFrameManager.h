#ifndef GCP_UTIL_DATAFRAMEMANAGER_H
#define GCP_UTIL_DATAFRAMEMANAGER_H
...
namespace gcp {
  namespace util {
    ...
    protected:
      ...
      gcp::util::DataFrame* frame_;// The data frame managed by this object
      
      bool dataIsInitialized_;     // False until the DataFrame buffer
				   // has been allocated
      unsigned currentIndex_;      // Current index into the DataFrame
				   // buffer
