#define __FILEPATH__ "util/common/RegAxisRange.cc"
 ...
 */
ostream& 
gcp::util::operator<<(ostream& os, RegAxisRange& range)
{
...
{
  *this = (RegAxisRange&) obj;
}

void RegAxisRange::operator=(RegAxisRange& obj)
{
  iSlotOffset_ = obj.iSlotOffset_;

  // And call the base-class operator too

  AxisRange::operator=(obj);
}
