#ifndef GCP_UTIL_ARRAYMAPDATAFRAMEMANAGER_H
#define GCP_UTIL_ARRAYMAPDATAFRAMEMANAGER_H
...
namespace gcp {
  namespace util {
    ...
    public:
      ...
      // Copy the contents of a BoardDataFrameManager to the
      // appropriate place in the array map.

      void writeBoard(BoardDataFrameManager& fm, 
		      bool lockFrame);

      void readBoard(BoardDataFrameManager& fm, 
		     bool lockFrame);
    ...
    protected:
      ...
      ArrayMap* arrayMap_;       // The GCP array map 
...
#endif // End #ifndef GCP_UTIL_ARRAYMAPDATAFRAMEMANAGER_H
