...
{
  arrayMap_ = (arrayMap == 0) ? alias_ArrayMap(arrayMapBase_.arrayMap()) : alias_ArrayMap(arrayMap);
  calData_ = 0;
...
RegCal::RegCal(RegCal& regCal)
{
  ...
  arrayMap_ = alias_ArrayMap(regCal.arrayMap_);
 ...
 *
 * Input:
 *  regmap    RegMap *   The register map of the GCP.
