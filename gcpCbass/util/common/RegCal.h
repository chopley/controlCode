#ifndef GCP_UTIL_REGCAL_H
#define GCP_UTIL_REGCAL_H
...
namespace gcp {
  namespace util {
	...
	void getCalComplexFloat(RegDescription* reg, gcp::util::MonitorDataType* data, 
...
#endif // End #ifndef GCP_UTIL_REGCAL_H
