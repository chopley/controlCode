#define __FILEPATH__ "util/common/LogFile.cc"
...
LogFile::~LogFile() 
{
  // Close the logfile if it was sucessfully opened
...
void LogFile::open()
{
  ...
  ReportMessage("Opened logfile: " << fileName << " on " 
 ...
 */
void LogFile::append(std::string message, bool fullTime)
{
 ...
 */
void LogFile::putLine(bool fullTime) 
{
  ostringstream os;
  ...
  if(fullTime)
    os << timeVal << ": " << prependStr_ << lineBuffer_.str() << endl;
  else
